...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400&family=DM+Mono:wght@400;500&family=Playfair+Display:wght@700;900&display=swap" rel="stylesheet">
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .chart-bars {
      display: flex; align-items: flex-end; gap: 8px; height: 100px; margin-bottom: 16px;
    }
    .chart-bar {
    ...
    .chart-months span { flex: 1; text-align: center; }
    ...
    .mini-card-val { font-size: 17px; font-weight: 700; }
    .mini-card-val.green { color: var(--success); }
    .mini-card-val.blue { color: var(--primary); }
    ...
    .float-badge.top-left { top: -20px; left: -30px; }
    .float-badge.bottom-right { bottom: -20px; right: -20px; }
    .float-icon {
    ...
    .course-thumb.blue { background: linear-gradient(135deg, #dcfce7, #bbf7d0); color: #15803d; }
    .course-thumb.green { background: linear-gradient(135deg, #dcfce7, #bbf7d0); color: #15803d; }
    .course-thumb.amber { background: linear-gradient(135deg, #fef3c7, #fde68a); color: #b45309; }
    ...
    .course-tag.blue { background: var(--primary-light); color: var(--primary); }
    .course-tag.green { background: var(--success-light); color: var(--success); }
    .course-tag.amber { background: var(--accent-light); color: #b45309; }
    .course-body h3 { font-size: 15px; font-weight: 700; margin-bottom: 6px; }
    .course-body p { font-size: 13px; color: var(--muted); line-height: 1.6; margin-bottom: 16px; }
    .course-footer {
    ...
    .testi-text { font-size: 15px; line-height: 1.7; margin-bottom: 20px; color: var(--text); }
    ...
    .cta-section p { color: rgba(255,255,255,.75); font-size: 16px; margin-bottom: 32px; position: relative; }
    .cta-actions { display: flex; gap: 12px; justify-content: center; position: relative; }
    .btn-white { background: #fff; color: var(--primary); font-size: 15px; padding: 14px 28px; border-radius: 14px; }
    .btn-white:hover { background: #f0f4ff; transform: translateY(-1px); }
    .btn-ghost { background: rgba(255,255,255,.15); color: #fff; font-size: 15px; padding: 14px 28px; border-radius: 14px; border: 1.5px solid rgba(255,255,255,.3); }
    ...
    .footer-brand p { font-size: 13px; color: var(--muted); margin-top: 12px; line-height: 1.65; max-width: 260px; }
    .footer-col h4 { font-size: 13px; font-weight: 700; letter-spacing: .04em; text-transform: uppercase; color: var(--muted); margin-bottom: 14px; }
    .footer-col a { display: block; color: var(--text); text-decoration: none; font-size: 14px; margin-bottom: 8px; transition: color .15s; }
    ...
    @media (max-width: 600px) {
      .features-grid, .courses-grid, .testi-grid { grid-template-columns: 1fr; }
...
<nav>
  <div class="nav-inner">
    ...
    <div class="nav-links">
      ...
      <a href="register.html" class="btn btn-primary" style="color: white;">Daftar Gratis</a>
    </div>
  </div>
</nav>
...
<div class="hero">
  <div>
    ...
    <p>Platform pembelajaran interaktif yang membantu Anda memahami neraca, laba-rugi, arus kas, dan analisis keuangan dengan cara yang mudah dan menyenangkan.</p>
    <div class="hero-actions">
      <a href="register.html" class="btn btn-primary btn-hero">
...
<section class="section" id="fitur">
  <div class="section-header">
    ...
    <p class="section-sub">Kami merancang pengalaman belajar yang terstruktur dan interaktif khusus untuk laporan keuangan.</p>
  </div>
  <div class="features-grid">
    <div class="feature-card fade-up">
      <div class="feature-icon blue">📊</div>
      <h3>Visualisasi Interaktif</h3>
      <p>Pahami laporan keuangan melalui grafik dan diagram interaktif yang memudahkan pemahaman konsep yang kompleks.</p>
    </div>
    <div class="feature-card fade-up">
      <div class="feature-icon green">✅</div>
      <h3>Kuis & Latihan Soal</h3>
      <p>Uji pemahaman Anda dengan ratusan soal latihan yang dirancang oleh pakar akuntansi dan keuangan berpengalaman.</p>
    </div>
    <div class="feature-card fade-up">
      <div class="feature-icon amber">🏆</div>
      <h3>Sertifikat Resmi</h3>
      <p>Dapatkan sertifikat penyelesaian yang dapat Anda tambahkan ke LinkedIn dan portofolio profesional Anda.</p>
    </div>
    <div class="feature-card fade-up">
      <div class="feature-icon blue">🎯</div>
      <h3>Jalur Belajar Terstruktur</h3>
      <p>Kurikulum yang dirancang dari dasar hingga mahir, memastikan tidak ada konsep penting yang terlewatkan.</p>
    </div>
    <div class="feature-card fade-up">
      <div class="feature-icon green">📱</div>
      <h3>Belajar di Mana Saja</h3>
      <p>Akses semua materi dari perangkat apapun — desktop, tablet, atau smartphone — kapanpun Anda mau.</p>
    </div>
    <div class="feature-card fade-up">
      <div class="feature-icon amber">👥</div>
      <h3>Komunitas Aktif</h3>
      <p>Bergabung dengan ribuan pelajar lain, diskusi, tanya jawab, dan berbagi pengalaman belajar bersama.</p>
    </div>
  </div>
</section>
...
<section class="section" id="kursus" style="padding-top:0">
  <div class="section-header">
    ...
    <p class="section-sub">Dari dasar akuntansi hingga analisis laporan keuangan tingkat lanjut.</p>
  </div>
  <div class="courses-grid">
    <a href="pembelajaran.html" class="course-card">
      ...
      <div class="course-body">
        ...
        <p>Pelajari tiga laporan keuangan utama: Neraca, Laba Rugi, dan Arus Kas dari nol.</p>
      </div>
    ...
    <a href="pembelajaran.html" class="course-card">
      ...
      <div class="course-body">
        ...
        <p>Menghitung dan menginterpretasikan rasio likuiditas, profitabilitas, dan solvabilitas perusahaan.</p>
      </div>
      <div class="course-footer">
        <div class="course-meta">
          <span>
    ...
    <a href="pembelajaran.html" class="course-card">
      ...
      <div class="course-body">
        ...
        <p>Memahami penerapan standar akuntansi internasional dalam penyusunan laporan keuangan perusahaan publik.</p>
      </div>
      <div class="course-footer">
        <div class="course-meta">
          <span>
...
<section class="section" id="testimoni" style="padding-top:0">
  ...
  <div class="testi-grid">
    <div class="testi-card">
      ...
      <p class="testi-text">"Awalnya saya bingung banget baca laporan keuangan. Setelah ikut kursus di FinReady, sekarang saya bisa analisis laporan perusahaan sendiri. Materinya sangat terstruktur dan mudah dipahami!"</p>
    ...
    <div class="testi-card">
      <div class="testi-stars">★★★★★</div>
      <p class="testi-text">"Platform terbaik untuk belajar akuntansi! Visualisasi interaktifnya membantu saya memahami konsep yang selama ini terasa rumit. Sertifikatnya juga langsung saya pakai di CV saya."</p>
      <div class="testi-author">
    ...
    <div class="testi-card">
      <div class="testi-stars">★★★★★</div>
      <p class="testi-text">"Sebagai pemilik UMKM, saya akhirnya bisa baca laporan keuangan bisnis sendiri tanpa harus bergantung akuntan. Sangat membantu untuk mengambil keputusan bisnis yang lebih baik."</p>
      <div class="testi-author">
    ...
    <div class="testi-card">
      <div class="testi-stars">★★★★☆</div>
      <p class="testi-text">"Kuis dan latihan soalnya sangat berguna untuk persiapan ujian CPA saya. Penjelasannya detail dan contoh kasusnya relevan dengan kondisi bisnis di Indonesia."</p>
      <div class="testi-author">
...
<div class="cta-section">
  ...
  <p>Bergabunglah dengan 10.000+ pelajar yang sudah meningkatkan kemampuan keuangan mereka bersama FinReady.</p>
  <div class="cta-actions">
    <a href="register.html" class="btn btn-white btn-hero">Daftar Gratis Sekarang</a>
...
<footer>
  <div class="footer-inner">
    <div class="footer-brand">
      ...
      <p>Platform pembelajaran laporan keuangan terpercaya untuk profesional dan pelajar di Indonesia.</p>
    </div>
